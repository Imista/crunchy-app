const txt_configuracion_usuario = document.querySelector(
    "#txt_configuracion_usuario"
);
const txt_configuracion_correo = document.querySelector(
    "#txt_configuracion_correo"
);
...
axios
    ...
    .then(function (response) {
        ...
        txt_configuracion_usuario.textContent = data.username;
        txt_configuracion_correo.textContent = data.email;
        img_perfil.src =
            data.photoUrl ||
